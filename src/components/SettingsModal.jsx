            ...
            >
                ...
                >
                    ...
                    <div className="p-6">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <h3 className="text-sm font-semibold text-slate-300 uppercase tracking-wider">Render Resolution</h3>
                            </div>
                            <div className="grid grid-cols-2 gap-2">
                                {RESOLUTIONS.map((res) => (
                                    ...
                                    >
                                        <span className={`text-sm font-bold ${selected === res.value ? 'text-indigo-400' : 'text-slate-300'}`}>
                                            {res.label}
                                        </span>
                                        <span className="text-xs text-slate-500 mt-0.5">{res.desc}</span>
                                    </button>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="flex justify-end gap-3 px-6 py-4 border-t border-slate-800">
                        ...
                        <button
                            onClick={handleSave}
                            className="px-4 py-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-500 rounded-xl transition-colors shadow-lg shadow-indigo-600/20"
                        >
                            Save
                        </button>
                    </div>
