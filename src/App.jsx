  ...
  const loadChatDetails = async (id) => {
    try {
      ...
      data.scenes.forEach(scene => {
        const imageUrl = scene.reference_image ? `http://localhost:8000${scene.reference_image}` : null;
            ...
            >
              ...
              <div className="flex items-center justify-between px-5 py-3 border-b border-slate-800">
                ...
                <div className="flex items-center gap-2">
                  <a
                    href={`http://localhost:8000${previewStitchedVideo.video_path}`}
                    download
              ...
              <div className="p-4 bg-black">
                <video
                  src={`http://localhost:8000${previewStitchedVideo.video_path}`}
                  controls
                  autoPlay
